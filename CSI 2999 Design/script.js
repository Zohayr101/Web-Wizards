...
const habitListWide = document.getElementById("habit-list-wide"); // For wide Habit Tracker
const changeThemeBtn = document.getElementById("change-theme-btn"); // "Change Theme" button
...
function renderHabitsWide() {
    habitListWide.innerHTML = "";
