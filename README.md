...
<p style="display: flex; flex-wrap: nowrap; align-items: center; gap: 10px; justify-content: center;">
  <img src="public/media/manual/movies.png" style="flex: 0 0 60%; max-width: 60%; height: auto;" alt="Movies Overview" />
  <img src="public/media/manual/movies1.png" style="flex: 0 0 35%; max-width: 35%; height: auto;" alt="Movies Details" />
</p>
